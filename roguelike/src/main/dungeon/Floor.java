...
public class Floor {
	...
	public Floor (int h, int w, EnumTheme t) {
		...
		for (int i = 1; i < rooms.length; i++){
			rooms[i] = new Room((int)(Math.random() * Globals.FLOOR_SIZE), (int)(Math.random() * Globals.FLOOR_SIZE));
		}
